...
public class ViewVendas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jtfQuantidade, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 80, 100, -1));

        jLabel5.setForeground(new java.awt.Color(0, 0, 153));
        jLabel5.setText("Quantidade:");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 60, -1, -1));

        jbAdicionar.setBackground(new java.awt.Color(0, 255, 51));
        jbAdicionar.setForeground(new java.awt.Color(0, 0, 153));
        jbAdicionar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/adicionar.png"))); // NOI18N
        ...
        jPanel1.add(jbAdicionar, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 70, -1, -1));

        jtProdutosVenda.setForeground(new java.awt.Color(0, 0, 153));
        ...
        jPanel1.add(jbCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 460, -1, -1));
        ...
        jPanel1.add(jbSalvar, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 460, -1, -1));
        ...
        jPanel1.add(jbNovo, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 460, -1, 30));
        ...
        jbRemoverProdutos.setForeground(new java.awt.Color(0, 0, 153));
        jbRemoverProdutos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/excluir.png"))); // NOI18N
        ...
        jPanel1.add(jbRemoverProdutos, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 460, -1, 30));
        ...
        jbPesquisar.setForeground(new java.awt.Color(0, 0, 153));
        ...
        jtVendas.setForeground(new java.awt.Color(0, 0, 153));
...
//                JOptionPane.showMessageDialog(this, "produtos da venda salvo com sucesso", "Atenção", JOptionPane.WARNING_MESSAGE);
    ...
    private void jbNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbNovoActionPerformed
        ...
        jcbNomeCliente.requestFocus();
        limparFormulario();
        // TESTANDO:
        /*this.desabilitaHabilitaCampos(true);
        this.limparCampos();
        this.jcbNomeCliente.requestFocus();
        alterarSalvar = "salvar";*/       
    ...
    private void jbPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbPesquisarActionPerformed
        ...
        classificador.setRowFilter(RowFilter.regexFilter(texto, 0, 1)); 
